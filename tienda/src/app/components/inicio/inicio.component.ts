    ...
    this._clienteService.obtener_config_publico().subscribe(
      response =>{
        response.data.categorias.forEach((element: any) => {
          if(element.titulo == 'Cafe Estándar'){
            this.categorias.push({
              titulo: element.titulo,
              portada: 'assets/img/ecommerce/cafecategoriasbgg/01.png'
            })
          }else if(element.titulo == 'Cafe Especial'){
            this.categorias.push({
              titulo: element.titulo,
              portada: 'assets/img/ecommerce/cafecategoriasbgg/02.png'
            });
          }else if(element.titulo == 'Cafe Tradicional'){
            this.categorias.push({
              titulo: element.titulo,
              portada: 'assets/img/ecommerce/cafecategoriasbgg/03.png'
            });
          }else if(element.titulo == 'Cafe Premium'){
            this.categorias.push({
              titulo: element.titulo,
              portada: 'assets/img/ecommerce/cafecategoriasbgg/04.png'
            });
          }
        });
