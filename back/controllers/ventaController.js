...
const registro_compra_cliente = async function (req, res) {
    if (req.user){
        ...
        data.nventa = n_venta; //n_venta  //'001'+ '-'+ '000001'
        ...
        detalles.forEach(async element => {
            ...
            //limpiar carrito despues de comprar
...
//FUNCION PARA CONVERTIR MI SERIE Y CORRELATIVO A UN SOLO NUMERO
...
const enviar_correo_compra_cliente = async function (req, res) {
    ...
    var transporter = nodemailer.createTransport(smtpTransport({
        ...
        host: 'smtp.gmail.com',
        auth: {
        user: 'asoprocafenpa@gmail.com',
        pass: 'npscscrxbyrgzazy'
        }
    }));
    ...
    readHTMLFile(process.cwd() + '/mail.html', (err, html)=>{         
        ...
        var mailOptions = {
            from: 'asoprocafenpa@gmail.com',
            to: venta.cliente.email,
            subject: 'Gracias por tu compra, Asoprocafenpa',
            html: htmlToSend
        };
